...
journal * journal::load_configuration(const YAML::Node & node, std::optional<uint64_t> size)
{
	...
	storage_backend *sb_data = storage_backend::load_configuration(cfg["storage-backend_data"], size);
